...
export const SLIDES = [
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: '💡', k: '이유', one: '<b>왜</b> 필요한지 한마디 하면 AI가 알아서 맞춥니다.', ex: '"폰에서 할 거니까" → 터치 버튼까지' },
      { emoji: '✅', k: '해줘 · 확인', one: '"할 수 있어?" ✕ "하지 마" ✕ → <b>"만들어줘"</b> ✓', ex: '끝에: "발판을 뚫지 않는지 확인해줘"' },
    ],
    note: '출처: Anthropic 프롬프팅 모범 사례. 역할 부여 / XML 구조화(→[라벨]) / 명확·직접 / 예시 활용 / 맥락·이유 추가 / 명시적 행동 지시 + 자체 점검. "새로 입사한 직원" 비유는 원문의 황금 규칙.',
  },
  {
    section: 'step1',
    type: 'annotated',
    ...
    lines: [
      ...
      { text: '할로우나이트처럼 어둡고 신비로운 2D 점프 게임을 만들어줘.', tags: ['🖼️ 예시', '✅ 해줘'] },
      { text: '' },
      ...
      { text: '[분위기] 푸른 어둠, 검은 실루엣, 멀리 산 실루엣이 천천히 움직이는 배경', tags: ['🖼️ 예시'] },
      { text: '[조건] HTML 파일 하나, <canvas>로 그리기.', tags: ['🎯 구체적'] },
      { text: '       폰에서도 할 거니까 화면 아래에 터치 버튼(←, →, 점프)', tags: ['💡 이유'] },
      { text: '' },
      { text: '다 만들면 캐릭터가 발판을 뚫고 지나가지 않는지 확인해줘.', tags: ['✅ 확인'] },
    ],
    foot: '오른쪽 태그는 어느 키워드를 쓴 줄인지 표시한 것입니다. 복사하면 태그 없이 프롬프트만 들어갑니다.',
    note: '학생이 붙여넣기 전에 태그를 하나씩 짚기: "첫 줄이 역할, [ ]가 칸 나누기, 숫자가 구체적, 할로우나이트가 예시, 폰에서가 이유, 마지막 줄이 확인." 1~2분 기다리는 동안 다음 슬라이드 예고.',
  },
  {
    section: 'step1',
    type: 'prompts',
