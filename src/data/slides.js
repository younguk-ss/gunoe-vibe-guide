...
export const SLIDES = [
  ...
  },
  {
    ...
    note: '4분 절대 초과 금지. 중학생 집중력은 오프닝 5분에 결정된다. 로고를 가리키며 "이것도 AI와 만든 제 로고입니다".',
  },
  {
    section: 'intro',
    type: 'links',
    kicker: '장흥의 바이브코딩 사례 · 6분',
    title: '말하지 말고, 플레이하기',
    bg: '/festival-banner.jpg',
    links: [
      {
        emoji: '📝',
        label: '어떻게 만들었나 — 블로그',
        desc: '수업 과정과 후기 기록',
        url: 'https://blog.naver.com/ywsun0914/224346763953',
      },
      {
        emoji: '🗺️',
        label: '물축제 홍보 사이트',
        desc: '픽셀 지도에서 게임으로',
        url: 'https://jh-water-map.vercel.app/',
      },
      {
        emoji: '🎮',
        label: '관산중 학생 작품',
        desc: '오늘 만들 것의 실물',
        url: 'https://jh-01.vercel.app/',
      },
    ],
    script: '이거 만든 사람, 여러분과 같은 <b>장흥 중학생</b>입니다.\n오늘 여러분도 <b>우리 학교가 배경인 게임</b>을 만들고, 끝나기 전에 <b>진짜 주소</b>가 생깁니다.',
    note: '카드를 클릭하면 바로 열린다. 관산중 작품은 학생 1명을 앞으로 불러 직접 플레이시키기 — 동기부여의 8할. 블로그는 짧게 스크롤만.',
  },
  {
    section: 'intro',
    type: 'flow',
